...
key = os.environ['API_USER_KEY']
user_backup = os.environ['API_USER_ID_BACKUP']
key_backup = os.environ['API_USER_KEY_BACKUP']
...
def lambda_handler(event, context):
    ...
    try:
        ...
        logged['diet_type'] = data['request']['diet-type']
        logged['calories'] = int(data['request']['calories'])

        plan = {}
        plan = randomMealPlan(logged['diet_type'], logged['calories'])
